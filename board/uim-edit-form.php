...
<nav class="navbar navbar-expand-sm navbar-dark">
  ...
  <div class="container mt-5 mb-5 text-center">
    ...
    <form action="uim-edit-script.php?edit= <?php echo $editData['user_id']; ?>" method="post">
      ...
      <div class="input-group">
        ...
        <!--------------------------------------->
          <select class="form-select" aria-label="Default select example" name="ref_nameprefix_id" >
        ...
        <!--------------------------------------->
        <input type="text" name="firstname" aria-label="First name" class="form-control" value="<?php echo $_SESSION['firstname']; ?>" >
        <input type="text" name="lastname" aria-label="Last name" class="form-control" value="<?php echo $_SESSION['lastname']; ?>" >
      </div>
      <br>                    
      <div class="input-group">
        <span class="input-group-text">สาขา</span>        
        <!--------------------------------------->
        <select class="form-select" aria-label="Default select example" name="ref_branch_id" hidden>
          ...
          <select class="form-select" aria-label="Default select example" name="ref_branch_id_show" disabled>
          <option value=""><?php echo $_SESSION['branch']; ?></option>
                            <?php foreach ($result_b as $results) : ?>
                                <option value="<?= $results['branch_id'] ?>"<?= $editData['ref_branch_id'] == $results['branch_id'] ? 'selected' : ''?>><?= $results['branch'] ?></option>
                            <?php endforeach; ?>
      ...
      <div class="input-group">
        ...
        <!--------------------------------------->
        <select class="form-select" aria-label="Default select example" name="ref_userlevel_id" hidden>
          <option value=""><?php echo $_SESSION['userlevel']; ?></option>
                        ...
                        <select class="form-select" aria-label="Default select example" name="ref_userlevel_id_show" disabled>
          <option value=""><?php echo $_SESSION['userlevel']; ?></option>
                            <?php foreach ($result_ul as $results) : ?>
                                <option value="<?= $results['userlevel_id'] ?>"<?= $editData['ref_userlevel_id'] == $results['userlevel_id'] ? 'selected' : ''?>><?= $results['userlevel'] ?></option>
                            <?php endforeach; ?>
      ...
      <div class="input-group">
        ...
        <input type="date" name="birthday" aria-label="birthday" class="form-control" value="<?php echo isset($editData) ? $editData['birthday'] : '' ?>" required>
      </div>
      <br>
      <div class="input-group">
        <span class="input-group-text">E-mail</span>
        <input type="text" name="email" aria-label="email" class="form-control" value="<?php echo isset($editData) ? $editData['email'] : '' ?>" required>
        <span class="input-group-text">@payap.ac.th</span>
      </div>
      <br>
