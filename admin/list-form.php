            ...
            <table class="table table-bordered mt-4">
              ...
              <tbody>
                ...
                while ($result = mysqli_fetch_array($query)) {
                  ...
                  <td><button style="color: white;" type="button"class="btn btn-warning"><a href="edit-form.php?edit=<?php echo $result['user_id'];?>">แก้ไข</button></td>
  ...
  <div class="container mt-5 text-center">
    ...
    <table class="table table-bordered mt-4">
            ...
            <tr>
                ...
                <td><button type="button"class="btn btn-warning"><a href="edit-form.php?edit=<?php echo $data['user_id'];?>">แก้ไข</a></button></td>
